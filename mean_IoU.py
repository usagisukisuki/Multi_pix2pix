...
def IoU(updater, enc, dec, rows, cols):
    @chainer.training.make_extension()
    def make_IoU(trainer):
	...
	#print(iou)
        #print(maku)
        #print(kaku)
        chainer.report({'haikei': haikei})
        chainer.report({'membranes': membranes})
        chainer.report({'mitochondria': mitochondria})
        chainer.report({'synapses': synapses})
        chainer.report({'IoU': iou})
